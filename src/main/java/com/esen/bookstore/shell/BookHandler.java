...
public class BookHandler {
    ...
    public void createBooks(String title, String author, String publisher, Double price) {
    ...
    @ShellMethod(value = "Finds by string types in book", key = "filter books")
    public String findByPublisherOrTitleOrAuthor(@ShellOption(defaultValue = ShellOption.NULL) String title,
                                                 @ShellOption(defaultValue = ShellOption.NULL) String author,
                                                 @ShellOption(defaultValue = ShellOption.NULL) String publisher) {
        return bookService.findByPublisherOrTitleOrAuthor(title, author, publisher)
                .stream()
                .map(Book::toString)
                .collect(Collectors.joining(System.lineSeparator()));
    }
